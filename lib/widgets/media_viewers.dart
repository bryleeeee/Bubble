...
class _MusicAttachmentCardState extends State<MusicAttachmentCard> with SingleTickerProviderStateMixin {
  bool _playing = false;
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('No audio snippet available.'))
        );
      }
    }
  }
            ...
            child: AnimatedContainer(
              ...
              child: _loadingAudio
                  ...
                  : Icon(
                      ...
                      color: _playing ? Colors.white : t.dominantColor,
                      size: 18,
                    ),
            ),
          ),
